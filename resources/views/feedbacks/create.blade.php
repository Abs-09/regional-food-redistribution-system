<x-app-layout>
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('feedbacks.create') }}"
                        class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Submit a Feedback</a>
                </div>
            </li>
        </ol>
    </nav>
    ...
    @endif
    <form action="{{ route('feedbacks.create') }}" method="post" class="py-5 px-20">
        @csrf
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Feed Back Form</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">Please fill out the feedback form to submit a feedback.
                </p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <p class="mt-3 text-sm leading-6 text-gray-600">Detailed description of problem</p>
                    </div>
                </div>
            </div>
